...
<html>
                    ...
                    <div class="b-nav__list menuH wow slideInRight" data-wow-delay="0.3s" >
                            <div class="navbar-collapse navbar-main-slide" style="color: #fff">
                                <ul class="navbar-nav-menu">
                                    <li><a style="color:#fff;" href="<?php echo e(route('cart-show')); ?>">Cart</a></li>
                                     <?php if(Auth::guest()): ?>
                                        <li><a style="color:#fff;" href="<?php echo e(url('/register')); ?>">Register</a></li>
                                        <li><a style="color:#fff;" href="<?php echo e(url('/login')); ?>">Sign in</a></li>

                                    <?php else: ?>    
                                    <li style="color:#fff;" class="dropdown">
                                        <a style="color:#fff;" class="dropdown-toggle" data-toggle='dropdown' href="#"><?php echo e(Auth::user()->name); ?> <span class="fa fa-caret-down"></span></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="b-topBar__nav" >
                                ...
                                <?php else: ?>
                                    <li class="dropdown">
                                        <a class="dropdown-toggle" data-toggle='dropdown' href="#"><?php echo e(Auth::user()->name); ?> <span class="fa fa-caret-down"></span></a>
                                        <ul class="dropdown-menu h-nav">
                                            <li>
                                                <a href="<?php echo e(url('/logout')); ?>"
                                                    onclick="event.preventDefault();
    ...
    <!-- End wrappage -->
        ...
        <script src="<?php echo e(asset('assets/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js')); ?>"></script>
        ...
        <!--Owl Carousel
        Viejo <script src="<?php echo e(asset('assets/owl-carousel/owl.carousel.min.js')); ?>"></script>-->
        
        <script src="<?php echo e(asset('assets/node_modules/owl.carousel/dist/owl.carousel.min.js')); ?>"></script>
        <!--bxSlider-->
        <script src="<?php echo e(asset('assets/bxslider/jquery.bxslider.js')); ?>"></script>
        <!-- jQuery UI Slider -->
        <script src="<?php echo e(asset('assets/slider/jquery.ui-slider.js')); ?>"></script>

        <!--Theme-->
        <script src="<?php echo e(asset('js/jquery.smooth-scroll.js')); ?>"></script>
        <script src="<?php echo e(asset('js/wow.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/jquery.placeholder.min.js')); ?>"></script>
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/js/map-icons.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/js/store.js')); ?>"></script>

        <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.elevatezoom.js')); ?>"></script>
