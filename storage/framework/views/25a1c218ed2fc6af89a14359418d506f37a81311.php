			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
							...
							<?php echo Form::open(['route'=>'model.store','method'=>'POST', 'data-parsley-validate', 'class' => 'form-horizontal form-label-left' ]); ?>


  
                        	<?php echo $__env->make('dashboard.model.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>							
