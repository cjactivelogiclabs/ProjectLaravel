		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">New Year</div>
					<div class="panel-body">
						<div class="col-md-6">
							<?php echo Form::open(['route'=>'year.store','method'=>'POST', 'data-parsley-validate', 'class' => 'form-horizontal form-label-left' ]); ?>


  
                        	<?php echo $__env->make('dashboard.year.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>							
