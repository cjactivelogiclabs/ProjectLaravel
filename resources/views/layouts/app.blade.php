...
<link rel="stylesheet" href="{{asset('css/dropUploader.css')}}">
...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/dashboard')}}"><span>NecTech</span>Dashboard</a>
                <ul class="user-menu">
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="{{ url('/user') }}"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Clients</a></li>
            <li><a href="{{ url('/maker') }}"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></use></svg> Makers</a></li>
            <li><a href="{{ url('/model') }}"><svg class="glyph stroked tag"><use xlink:href="#stroked-tag"/></use></svg> Models</a></li>
            <li><a href="{{ url('/product') }}"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Products</a></li>
            <li><a href="{{ url('/slide') }}"><svg class="glyph stroked camera"><use xlink:href="#stroked-camera"></use></svg> Slide image</a></li>
