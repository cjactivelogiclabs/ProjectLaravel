            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                <div class="col-md-10">
                                    {!! Form::open(array('method'=>'POST','route' => ['product.store'],'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="form-group">
                                            <label>Supplier</label>
                                             {!! Form::select('supplier', $suppliers, null, ['id' => 'supplier', 'class' => 'js-example-basic-single form-control' ,'required']) !!}
                                        </div> 

                                        <div class="form-group">
                                            <label>Condition option</label>
                                             {!! Form::select('condition_o', $condition, null, ['id' => 'condition_o','class' => 'form-control' , 'placeholder'=>'Condition']) !!}
                                        </div> 
                                        <div class="form-group">
                                            <label>Categoric</label>
                                             {!! Form::select('categoric', $categoric, null, ['id' => 'categoric','class' => 'form-control' , 'placeholder'=>'Categoric']) !!}
                                        </div> 
                                        <div class="form-group">
                                            <label>Weight</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('board_programming', $board_programming, null, ['id' => 'board_programming','class' => 'form-control' , 'placeholder'=>'On Board Programming']) !!}
                                        </div>
                                        <div class="form-group">
                                            <label>Emergency Key</label>
                                            {!! Form::select('emergency_key', $emergency_key, null, ['id' => 'board_programming','class' => 'form-control' , 'placeholder'=>'Emergency Key']) !!}
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Maker</label>
                                             {!! Form::select('id_maker', $makers, null, ['id' => 'id_maker','class' => 'form-control' , 'placeholder'=>'Makers','required']) !!}
                                        </div> 
                                        <div class="form-group">
                                            <label>Model</label>
                                             {!! Form::select('model[]', $models, null, ['id' => 'model', 'multiple'=>true, 'class' => 'js-example-basic-multiple form-control','disabled' ,'required']) !!}
                                        </div> 

                                        <div class="form-group">
                                            <label>Year</label>
                                            {!! Form::select('year[]', $years, null, ['id' => 'year', 'multiple'=>true, 'class' => 'js-example-basic-multiple form-control','required']) !!}
                                        </div> 
